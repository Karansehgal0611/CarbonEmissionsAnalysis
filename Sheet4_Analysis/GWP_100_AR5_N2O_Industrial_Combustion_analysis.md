# Analysis of GWP_100 AR5 N2O Emissions from Industrial Combustion

## 1. Full-Series Trend (1970–2024): High-Level Insights

The series shows a long-run growth in emissions from **~1 Mt CO2eq** in 1970 to **~6 Mt CO2eq** in 2024.

Key quantitative features visible in the curve:
- **1970–1990**: Emissions moved from ~1 to ~1 Mt CO2eq.
- **1990–2005**: Emissions moved from ~1 to ~2 Mt CO2eq.
- **2005–2020**: Emissions moved from ~2 to ~5 Mt CO2eq.
- **2020–2024**: Emissions moved from ~5 to ~6 Mt CO2eq.

## 2. Breakpoint Detection and Regime Analysis

The analysis identified **3 structural breakpoints** at: 1990, 2005, 2020. These correspond to significant shifts in the emissions trend.
...
### Regime 2: 1990–2004
- **Trend**: This regime shows a slope of **0.05**, indicating the rate of change in emissions.
- **Emissions Range**: Emissions grew from ~1 to ~2 Mt CO2eq.
- **Inference**: A change in slope from the previous regime suggests a structural shift. A steeper slope indicates accelerated emissions growth, likely tied to increased activity in the Industrial Combustion sector, while a flatter slope suggests a slowdown.

### Regime 3: 2005–2019
- **Trend**: This regime shows a slope of **0.18**, indicating the rate of change in emissions.
- **Emissions Range**: Emissions grew from ~2 to ~5 Mt CO2eq.
- **Inference**: A change in slope from the previous regime suggests a structural shift. A steeper slope indicates accelerated emissions growth, likely tied to increased activity in the Industrial Combustion sector, while a flatter slope suggests a slowdown.

### Regime 4: 2020–2024
- **Trend**: This regime shows a slope of **0.29**, indicating the rate of change in emissions.
- **Emissions Range**: Emissions grew from ~5 to ~6 Mt CO2eq.
- **Inference**: A change in slope from the previous regime suggests a structural shift. A steeper slope indicates accelerated emissions growth, likely tied to increased activity in the Industrial Combustion sector, while a flatter slope suggests a slowdown.
...
**Slope Behavior**:
- The model identifies genuine trend shifts. The slopes of the segments are: 0.01, 0.05, 0.18, 0.29.
...
- **Forecast**: The model projects that emissions will reach **~5 Mt CO2eq by 2034**.
