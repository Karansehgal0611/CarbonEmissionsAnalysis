# Analysis of GWP_100 AR5 CH4 Emissions from Processes

## 1. Full-Series Trend (1970–2024): High-Level Insights

The series shows a long-run growth in emissions from **~0 Mt CO2eq** in 1970 to **~0 Mt CO2eq** in 2024.

Key quantitative features visible in the curve:
- **1970–1984**: Emissions moved from ~0 to ~0 Mt CO2eq.
- **1984–2006**: Emissions moved from ~0 to ~0 Mt CO2eq.
- **2006–2020**: Emissions moved from ~0 to ~0 Mt CO2eq.
- **2020–2024**: Emissions moved from ~0 to ~0 Mt CO2eq.

## 2. Breakpoint Detection and Regime Analysis

The analysis identified **3 structural breakpoints** at: 1984, 2006, 2020. These correspond to significant shifts in the emissions trend.
...
**Slope Behavior**:
- The model identifies genuine trend shifts. The slopes of the segments are: -0.00, 0.00, 0.01, 0.03.
...
The 10-year forecast is based on the final regime's ARIMA(1, 1, 0) model.
