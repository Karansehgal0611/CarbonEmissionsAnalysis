# Analysis of CO2 Emissions from Processes

## 1. Full-Series Trend (1970–2024): High-Level Insights

The series shows a long-run growth in emissions from **~16 Mt CO2eq** in 1970 to **~253 Mt CO2eq** in 2024.

Key quantitative features visible in the curve:
- **1970–1983**: Emissions moved from ~16 to ~23 Mt CO2eq.
- **1983–2002**: Emissions moved from ~24 to ~73 Mt CO2eq.
- **2002–2020**: Emissions moved from ~79 to ~194 Mt CO2eq.
- **2020–2024**: Emissions moved from ~177 to ~253 Mt CO2eq.

## 2. Breakpoint Detection and Regime Analysis

The analysis identified **3 structural breakpoints** at: 1983, 2002, 2020. These correspond to significant shifts in the emissions trend.

### Regime 1: 1970–1982
- **Trend**: This regime shows a slope of **0.48**, indicating the rate of change in emissions.
- **Emissions Range**: Emissions grew from ~16 to ~23 Mt CO2eq.
...
- **Emissions Range**: Emissions grew from ~24 to ~73 Mt CO2eq.
- **Inference**: A change in slope from the previous regime suggests a structural shift. A steeper slope indicates accelerated emissions growth, likely tied to increased activity in the Processes sector, while a flatter slope suggests a slowdown.

### Regime 3: 2002–2019
- **Trend**: This regime shows a slope of **6.76**, indicating the rate of change in emissions.
- **Emissions Range**: Emissions grew from ~79 to ~194 Mt CO2eq.
- **Inference**: A change in slope from the previous regime suggests a structural shift. A steeper slope indicates accelerated emissions growth, likely tied to increased activity in the Processes sector, while a flatter slope suggests a slowdown.

### Regime 4: 2020–2024
- **Trend**: This regime shows a slope of **13.42**, indicating the rate of change in emissions.
- **Emissions Range**: Emissions grew from ~177 to ~253 Mt CO2eq.
- **Inference**: A change in slope from the previous regime suggests a structural shift. A steeper slope indicates accelerated emissions growth, likely tied to increased activity in the Processes sector, while a flatter slope suggests a slowdown.
...
**Slope Behavior**:
- The model identifies genuine trend shifts. The slopes of the segments are: 0.48, 2.81, 6.76, 13.42.
...
- **Forecast**: The model projects that emissions will reach **~437 Mt CO2eq by 2034**.
