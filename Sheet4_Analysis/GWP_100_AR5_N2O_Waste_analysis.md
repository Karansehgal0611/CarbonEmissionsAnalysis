# Analysis of GWP_100 AR5 N2O Emissions from Waste

## 1. Full-Series Trend (1970–2024): High-Level Insights

The series shows a long-run growth in emissions from **~5 Mt CO2eq** in 1970 to **~19 Mt CO2eq** in 2024.

Key quantitative features visible in the curve:
- **1970–1976**: Emissions moved from ~5 to ~5 Mt CO2eq.
- **1976–1998**: Emissions moved from ~5 to ~10 Mt CO2eq.
- **1998–2005**: Emissions moved from ~10 to ~11 Mt CO2eq.
- **2005–2024**: Emissions moved from ~11 to ~19 Mt CO2eq.

## 2. Breakpoint Detection and Regime Analysis

The analysis identified **3 structural breakpoints** at: 1976, 1998, 2005. These correspond to significant shifts in the emissions trend.

### Regime 1: 1970–1975
- **Trend**: This regime shows a slope of **0.07**, indicating the rate of change in emissions.
- **Emissions Range**: Emissions grew from ~5 to ~5 Mt CO2eq.
...
### Regime 2: 1976–1997
- **Trend**: This regime shows a slope of **0.22**, indicating the rate of change in emissions.
- **Emissions Range**: Emissions grew from ~5 to ~10 Mt CO2eq.
- **Inference**: A change in slope from the previous regime suggests a structural shift. A steeper slope indicates accelerated emissions growth, likely tied to increased activity in the Waste sector, while a flatter slope suggests a slowdown.

### Regime 3: 1998–2004
- **Trend**: This regime shows a slope of **0.11**, indicating the rate of change in emissions.
- **Emissions Range**: Emissions grew from ~10 to ~11 Mt CO2eq.
- **Inference**: A change in slope from the previous regime suggests a structural shift. A steeper slope indicates accelerated emissions growth, likely tied to increased activity in the Waste sector, while a flatter slope suggests a slowdown.

### Regime 4: 2005–2024
- **Trend**: This regime shows a slope of **0.41**, indicating the rate of change in emissions.
- **Emissions Range**: Emissions grew from ~11 to ~19 Mt CO2eq.
- **Inference**: A change in slope from the previous regime suggests a structural shift. A steeper slope indicates accelerated emissions growth, likely tied to increased activity in the Waste sector, while a flatter slope suggests a slowdown.
...
**Slope Behavior**:
- The model identifies genuine trend shifts. The slopes of the segments are: 0.07, 0.22, 0.11, 0.41.
...
- **Forecast**: The model projects that emissions will reach **~23 Mt CO2eq by 2034**.
...
- **The most recent regime (post-2005) drives a strong upward forecast**, projecting continued emissions growth over the next decade.
